...
<Steps>
  ...
  <Step title="Install the Salesforce App" stepNumber={3}>
  ...
  <Step title="Assign the ConverseKit Permission Set" stepNumber={4}>
    After installation:
  ...
  <Step title="Connect Your Salesforce Org" stepNumber={5}>
