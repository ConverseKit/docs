...
title: "🌐 Create ConverseKit Number"
---
...
4. Fill in the following:
   ...
   - `Area Code `– Enter a 3-digit area code based on the region you'd like your number to originate from (e.g., `415` for San Francisco)
5. Click **Create**.
