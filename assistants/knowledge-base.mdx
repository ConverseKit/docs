...
<Steps>
  ...
  <Step title="🧩 Step 2: Create a Knowledge Base">
    1. Goto the **Assistants** tab.
    2. Open any Assistant you’d like to enrich with knowledge. Navigate to the **Knowledge Base** section inside the Assistant details page.
    3. Click **“Create Knowledge Base.”**
    4. Select one or more **uploaded documents** from Step 1.
    5. _(Optional)_ Add any **web URLs** you want the assistant to crawl and learn from.
    6. Click **Save**.
  </Step>
</Steps>
